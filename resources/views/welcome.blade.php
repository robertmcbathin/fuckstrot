        ...
        <div class="page-header page-header-mini">
            ...
            <div class="content-center">
                ...
                <div class="form-group hidden-xs hidden-sm">
                                                <input type="text" value="" placeholder="Search something interesting" class="form-control">
                                            </div>
            </div>
        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-testimonial">
                            <div class="card-avatar">
                                <a href="landing-page.html#pablo">
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3 text-center">
                        ...
                        <ul class="nav nav-pills nav-pills-primary justify-content-center" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="landing-page.html#pill1" role="tablist">
                                    Legal Entity
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="landing-page.html#pill2" role="tablist">
                                    Individual
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-4">
                        <div class="card card-pricing card-plain">
                            <div class="card-block">
                                ...
                                <a href="landing-page.html#pablo" class="btn btn-primary btn-round">
                                    Sign Up
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-pricing card-background card-raised" style="background-image: url('../assets/img/pricing2.jpg')">
                            <div class="card-block">
                                ...
                                <a href="landing-page.html#pablo" class="btn btn-neutral btn-round">
                                    Sign Up
                                </a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 text-center offset-lg-3 col-md-8 offset-md-2">
                        ...
                        <div class="send-button">
                            <a href="landing-page.html#pablo" class="btn btn-primary btn-round btn-block btn-lg">Send Message</a>
                        </div>
                    </div>
                </div>
            </div>
